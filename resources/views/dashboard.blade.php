...
<!-- DITO NAKALAGAY YUNG SA PROFILE NUNG NAKALOGIN -->
        ...
        <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::user()->name }}</span>
            ...
            <!--DROP DOWN  SA PROFILE-->
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    <li>
              <form id="logoutForm" action="{{ route('logout') }}" method="POST" style="display: none;">
                  @csrf
              </form>
              <a class="dropdown-item d-flex align-items-center" href="#" id="logoutBtn" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">
